...
Release `1.16.0` is the current line:

```kotlin
dependencies {
    implementation("no.beint.skaldpdf:skald-layout:1.16.0")
    implementation("no.beint.skaldpdf:skald-fonts:1.16.0")         // direct SkaldSans API access
    implementation("no.beint.skaldpdf:skald-barcode:1.16.0")        // optional symbols
    implementation("no.beint.skaldpdf:skald-invoice-no:1.16.0")    // optional Norwegian invoice
    implementation("no.beint.skaldpdf:skald-label-sticker:1.16.0") // optional clothing stickers
    implementation("no.beint.skaldpdf:skald-sign:1.16.0")          // optional integrity seals
    implementation("no.beint.skaldpdf:skald-image:1.16.0")         // optional JPEG/PNG/GIF/BMP/HEIC/JXL ingest
    implementation("no.beint.skaldpdf:skald-optimize:1.16.0")      // optional received-PDF recompress
    implementation("no.beint.skaldpdf:skald-optimize-jpegli:1.16.0") // optional bundled JPEGli encoder
}
```
